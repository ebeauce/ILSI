...
exp_params[1]['C'] = 0.65
exp_params[1]['min_instability'] = 0.90 if scenarios == 'mild' else 0.80
...
exp_params[2]['C'] = 0.85
exp_params[2]['min_instability'] = 0.90 if scenarios == 'mild' else 0.80
exp_params[2]['max_acceptance_p'] = 0.0
exp_params[2]['random_comp_friction'] = 0.20 if scenarios == 'mild' else 0.40 # mu ranges from 0.2 to 1.0
...
exp_params[3]['C'] = 0.65
exp_params[3]['min_instability'] = 0.90 if scenarios == 'mild' else 0.80
exp_params[3]['max_acceptance_p'] = 0.25
exp_params[3]['random_comp_friction'] = 0.20 if scenarios == 'mild' else 0.40 # mu ranges from 0.2 to 1.0
...
exp_params[4]['C'] = 0.65
exp_params[4]['min_instability'] = 0.90 if scenarios == 'mild' else 0.80
...
exp_params[5]['C'] = 0.65
exp_params[5]['min_instability'] = 0.90 if scenarios == 'mild' else 0.80
exp_params[5]['max_acceptance_p'] = 0.0
exp_params[5]['random_comp_friction'] = 0.20 if scenarios == 'mild' else 0.40 # mu ranges from 0.2 to 1.0
...
exp_params[6]['C'] = 0.65
exp_params[6]['min_instability'] = 0.90 if scenarios == 'mild' else 0.80
exp_params[6]['max_acceptance_p'] = 0.25
exp_params[6]['random_comp_friction'] = 0.20 if scenarios == 'mild' else 0.40 # mu ranges from 0.2 to 1.0
